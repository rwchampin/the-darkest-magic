  ...
  *********************************/
  ...
  const yo = () => {
    ...
    function init() {
      ...
      // window.innerHeight = theCanvas.height;
    ...
    function onTimer() {
      ...
      while (p != null) {
        colorIndex++;
        const color = `#${new THREE.Color().setHSL(0.5 + THREE.MathUtils.randInt(201, 250) / 3 * 0.25, 0.6, 0.7).getHexString()}`
        ...
        */
        ...
        if (outsideTest || p.dead) {
          ...
          context.fillStyle = color;//rgbString + depthAlphaFactor * p.alpha + ")";
