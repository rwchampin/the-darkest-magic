...
export default defineNuxtConfig({
  server: {
    https: {
      key: fs.readFileSync(fileURLToPath(new URL('./ssl/example.com+5-key.pem', import.meta.url))),
      cert: fs.readFileSync(fileURLToPath(new URL('./ssl/example.com+5.pem', import.meta.url))),
    },
  },
  alias: {
