...
import { useBlackEnergy } from '~/composables/BlackEnergy'
import useCore from '~/composables/useCore.ts'
import { Effects } from '~/utils/Effects'
// ** Get NUXTAPP ** //

let stats, suniforms, scene, camera, renderer, ambientLight, pointLight, directionalLight, rectAreaLight, spotLight, hemisphereLight
