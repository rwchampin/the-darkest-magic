  ...
  nextTick(() => {
    ...
    class Paramecium {
      ...
      move() {
        ...
        /*
        * Check if the particle is out of the canvas
        */
        if (this.x < 0 || this.x > this.w - this.radius)
          return false
        if (this.y < 0 || this.y > this.h - this.radius)
        ...
        if (mouseCollision) {
          Utils.math.v2.sub(this, mouse, this)
          Utils.math.v2.normalize(this, this)
          Utils.math.v2.scale(this, this, 0.1)
          Utils.math.v2.add(this, this, mouse)
        }
