...
onMounted(() => {
  ...
  const c1 = Utils.createCanvas({ width: w, height: 300 })
  const c2 = Utils.createCanvas({ width: w, height: 300 })
  const c3 = Utils.createCanvas({ width: 500, height: 300, id: 'error-canvas' })
