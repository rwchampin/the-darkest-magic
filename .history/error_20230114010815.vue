...
onMounted(() => {
  ...
  const c1 = Utils.createCanvas({ width: w, height: h, type: '2d' })
  const c2 = Utils.createCanvas({ width: w, height: h, type: '2d' })
  const c3 = Utils.createCanvas({ width: w, height: h, type: '2d' })
  debugger
