...
function createLight(color) {
  ...
  let geometry = new THREE.SphereGeometry(0.03, 12, 6)
  ...
  geometry = new THREE.SphereGeometry(0.01, 16, 8)
    ...
    function mouseMe() {
      ...
      function onMouseMove(event) {
        ...
        for (let i = 0; i < intersects.length; i++) {
          ...
          mousePointLight.position.set(intersects[i].point.x, intersects[i].point.y, intersects[i].point.z - 2)
        }
