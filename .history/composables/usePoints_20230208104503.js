...
export const usePoints = ({ scene, camera, renderer, nuxtApp }) => {
    ...
    const shaderMaterial = new THREE.ShaderMaterial({
        uniforms: {
            pointTexture: {
                value: new THREE.TextureLoader().load(m)
            }
        },
        vertexShader: `
    ...
    const updateParticles = () => {
        ...
        //     debugger;
            ...
            ps[x] =  Utils.noise.simplex3(x0, y0,z0) * THREE.MathUtils.randFloatSpread(.5)
            ps[x + 1] = Utils.noise.simplex3(x1, y1,z1) * THREE.MathUtils.randFloatSpread(.5)
            ps[x + 2] = Utils.noise.simplex3(x2, y2,z2)* THREE.MathUtils.randFloatSpread(.5)
