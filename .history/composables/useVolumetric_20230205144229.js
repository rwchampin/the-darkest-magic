...
const useVolumetric = ({ scene, camera, renderer }) => {
  ...
  const renderParticles = () => {
    ...
    introCanvas.setAttribute("id", "introCanvas");
    introCanvas.width = window.innerWidth;
    introCanvas.height = window.innerHeight;
    introCanvas.style.position = "fixed";
    introCanvas.style.top = "0px";
    introCanvas.style.left = "0px";
    introCanvas.style.zIndex = "9999999999";
