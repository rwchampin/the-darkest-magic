...
const val = Math.random() * (Math.PI*2);
            ...
            ps[q] = v1.x + THREE.MathUtils.clamp(theta1, 0, Math.PI*2) 
            ps[q+1] = v1.y + THREE.MathUtils.clamp(theta1, 0, Math.PI*2) 
            ps[q+2] = v1.z + THREE.MathUtils.clamp(theta1, 0, Math.PI*2) 
            theta1 += val
        }
