   ...
   geometry.setAttribute( 'position', new THREE.Float32BufferAttribute( positions, 3 ) );
    ...
    const updateParticles = () => {
        ...
        //     debugger;
            ...
            const finalX = x0 + Utils.noise.perlin3(x0, y0,z0) * THREE.MathUtils.randFloatSpread(.5)
            const finalY = y0 + Utils.noise.simplex3(x0,y0,z0) * THREE.MathUtils.randFloatSpread(.5)
            const finalZ = z0 + Utils.noise.simplex3(x0,y0,z0)* THREE.MathUtils.randFloatSpread(.5)
