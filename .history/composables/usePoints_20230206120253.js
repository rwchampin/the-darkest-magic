...
export const usePoints = ({ scene, camera, renderer }) => {
    ...
    function draw() {
        ...
        for (i = 0; i < 2000; i++) {
            ...
            const x = Utils.noise.simplex3(x0, sphereCenterY + y0, sphereCenterZ + z0);
            const y = Utils.noise.simplex3(x0 + 1, sphereCenterY + y0 + 1, sphereCenterZ + z0 + 1);
            const z = Utils.noise.simplex3(x0 + 2, sphereCenterY + y0 + 2, sphereCenterZ + z0 + 2);
