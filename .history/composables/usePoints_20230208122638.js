   ...
   geometry.setAttribute( 'position', new THREE.Float32BufferAttribute( positions, 3 ) );
    ...
    const updateParticles = () => {
        ...
        //     debugger;
            ...
            const x0 = radius * Math.cos(theta*t) * Math.sin(phi)
            const y0 = radius * Math.sin(theta*t) * Math.sin(phi)
            const z0 = radius * Math.cos(phi*t);
            ...
            ps[x + 2] = z0 + Utils.noise.simplex3(x0,y0,z0)* THREE.MathUtils.randFloatSpread(.5)
