   ...
   geometry.setAttribute( 'position', new THREE.Float32BufferAttribute( positions, 3 ) );
    ...
    const updateParticles = () => {
        ...
        //     debugger;
            ...
            ps[x] = x0  + improved.noise(x0, y0,z0) * THREE.MathUtils.randFloatSpread(.5)
            ps[x + 1] = y0 + improved.noise(x1, y1,z1) * THREE.MathUtils.randFloatSpread(.5)
            ps[x + 2] = z0 + improved.noise(x2, y2,z2)* THREE.MathUtils.randFloatSpread(.5)
