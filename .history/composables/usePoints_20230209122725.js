   ...
   geometry.setAttribute( 'position', new THREE.Float32BufferAttribute( positions, 3 ) );
    ...
    const updateParticles = () => {
        ...
        //     debugger;
            ...
            let finalY = y0 + Utils.noise.perlin3(x0,y0,z0) * THREE.MathUtils.randFloatSpread(.5)
            let finalZ = z0 + Utils.noise.perlin3(x0,y0,z0)* THREE.MathUtils.randFloatSpread(.5)
