...
import { useVolumetric } from './useVolumetric'
   ...
   geometry.setAttribute( 'position', new THREE.Float32BufferAttribute( positions, 3 ) );
    ...
    const updateParticles = () => {
        ...
        for (let x = 0; x < count; x+=3) {
            ...
            const v1 = new THREE.Vector3(ps[x], ps[x+1], ps[x+2])
        ...
        //     debugger;
            ...
            const v2 = new THREE.Vector3(finalX, finalY, finalZ)

            const ll1 = new THREE.Vector3.lerpVectors(v1, v2, .1);
            const l2l = new THREE.Vector3.lerpVectors(v1, v2, .2);
            const l3l = new THREE.Vector3.lerpVectors(v1, v2, .3);
            const l4l = new THREE.Vector3.lerpVectors(v1, v2, .4);
            const l5l = new THREE.Vector3.lerpVectors(v1, v2, .5);
            const l6l = new THREE.Vector3.lerpVectors(v1, v2, .6);
            const l7l = new THREE.Vector3.lerpVectors(v1, v2, .7);
            debugger
            ps[x] = finalX;
            ps[x + 1] = finalY;
            ps[x + 2] = finalZ
