...
export const usePoints = ({ scene, camera, renderer, nuxtApp }) => {
    ...
    const updateNucleus = () => {
        ...
        for (let l = 0; l < nucLength; l += 3) {
            const x = pos[l] + Utils.noise.perlin3(pos[l], pos[l + 1], pos[l + 2])
            const y = pos[l + 1] + Utils.noise.perlin3(pos[l], pos[l + 1], pos[l + 2])
            const z = pos[l + 2] + Utils.noise.perlin3(pos[l], pos[l + 1], pos[l + 2])
