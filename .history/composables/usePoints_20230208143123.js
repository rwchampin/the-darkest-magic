   ...
   geometry.setAttribute( 'position', new THREE.Float32BufferAttribute( positions, 3 ) );
    ...
    const updateParticles = () => {
        ...
        //     debugger;
            ...
            const ll = THREE.MathUtils.lerp(v1.x, v2.x, THREE.MathUtils.clamp(t,0,1))
            const ll2 = THREE.MathUtils.lerp(v1.x, v2.x, .2)
            const ll3 = THREE.MathUtils.lerp(v1.x, v2.x, .3)
            const ll4 = THREE.MathUtils.lerp(v1.x, v2.x, .4)
            const ll5 = THREE.MathUtils.lerp(v1.x, v2.x, .5)
            const ll6 = THREE.MathUtils.lerp(v1.x, v2.x, .6 )
