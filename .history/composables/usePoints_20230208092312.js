   ...
   geometry.setAttribute( 'position', new THREE.Float32BufferAttribute( positions, 3 ) );
    ...
    const updateParticles = () => {
        ...
        for (let x = 0; x < count; x+=3) {
            ...
            const theta = t*THREE.MathUtils.randFloatSpread(360);
            const phi = t*THREE.MathUtils.randFloatSpread(360);
        //     debugger;
            ...
            ps[x] = x0// + Utils.noise.simplex3(x0, y0,z0) * THREE.MathUtils.randFloatSpread(.5)
            ps[x + 1] = y0//+ Utils.noise.simplex3(x1, y1,z1) * THREE.MathUtils.randFloatSpread(.5)
            ps[x + 2] = z0//+ Utils.noise.simplex3(x2, y2,z2)* THREE.MathUtils.randFloatSpread(.5)
