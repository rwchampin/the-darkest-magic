...
import m from '~/assets/particles/flash.png'
   ...
   geometry.setAttribute( 'position', new THREE.Float32BufferAttribute( positions, 3 ) );
    ...
    const updateParticles = () => {
        ...
        //     debugger;
            ...
            const x1 = radius * Math.cos(theta) * Math.sin(phi)
            const y1 = radius * Math.sin(theta) * Math.sin(phi)
            const z1 = radius * Math.cos(phi);

            const x2 = radius * Math.cos(theta) * Math.sin(phi)
            const y2 = radius * Math.sin(theta) * Math.sin(phi)
            const z2 = radius * Math.cos(phi);

            const lerpX = Utils.animation.lerp(x0 + Utils.noise.perlin3(x0, y0,z0) * THREE.MathUtils.randFloatSpread(1), prev[x], t)
            const lerpY = Utils.animation.lerp(y0 + Utils.noise.perlin3(x1, y1, z1) * THREE.MathUtils.randFloatSpread(1), prev[x + 1], t)
            
            const lerpZ =  Utils.animation.lerp(z0+ Utils.noise.perlin3(x2, y2,z2)* THREE.MathUtils.randFloatSpread(1), prev[x+2],t)

       ps[x] = x0 + Utils.noise.perlin3(x0, y0,z0) * THREE.MathUtils.randFloatSpread(1)
            ps[x + 1] = y0+ Utils.noise.perlin3(x1, y1,z1) * THREE.MathUtils.randFloatSpread(1)
            ps[x + 2] = z0+ Utils.noise.perlin3(x2, y2,z2)* THREE.MathUtils.randFloatSpread(1)
