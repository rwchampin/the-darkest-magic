...
//   onMounted(() => {
  ...
  (function () {
    let scene; let camera; let renderer; let composer; let box; let pointLight; let occlusionComposer; let occlusionRenderTarget; let occlusionBox; let lightSphere
    ...
    function setupPostprocessing() {
      ...
      pass = new THREE.ShaderPass(volumetricMaterial)
