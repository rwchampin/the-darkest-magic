   ...
   geometry.setAttribute( 'position', new THREE.Float32BufferAttribute( positions, 3 ) );
    ...
    const updateParticles = () => {
        ...
        //     debugger;
            ...
            const lx = THREE.MathUtils.lerp(v2.x, v1.x, THREE.MathUtils.clamp(t,0,1))
            const ly = THREE.MathUtils.lerp(v2.y, v1.y, THREE.MathUtils.clamp(t,0,1))
            const lz = THREE.MathUtils.lerp(v2.z, v1.z, THREE.MathUtils.clamp(t,0,1))

            const newVec = new THREE.Vector3(lx,ly,lz).multiplyScalar(1)
