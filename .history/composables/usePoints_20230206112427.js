...
export const usePoints = ({ scene, camera, renderer }) => {
    ...
    function draw() {
        ...
        for (i = 0; i < 2000; i++) {
            ...
            const x1 = Utils.noise.perlin3(p.x*(Math.random()*gravity), p.y*(Math.random()*gravity), p.z*(Math.random()*gravity));
            const y1 = Utils.noise.perlin3(p.x*(Math.random()*gravity), p.y*(Math.random()*gravity), p.z*(Math.random()*gravity));
            const z1 = Utils.noise.perlin3(p.x*(Math.random()*gravity), p.y*(Math.random()*gravity), p.z*(Math.random()*gravity));

            vertices.push(p.x, p.y, p.z, x1, y1, z1);
        }
