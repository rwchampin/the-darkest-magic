...
export const usePoints = ({ scene, camera, renderer, nuxtApp }) => {
    ...
    const updateNucleus = () => {
        ...
        for (let l = 0; l < nucLength; l += 3) {
            const x = nucPos[l] + Utils.noise.perlin3(nucPos[l], nucPos[l + 1], nucPos[l + 2])
            const y = nucPos[l + 1] + Utils.noise.perlin3(nucPos[l], nucPos[l + 1], nucPos[l + 2])
            const z = nucPos[l + 2] + Utils.noise.perlin3(nucPos[l], nucPos[l + 1], nucPos[l + 2])
