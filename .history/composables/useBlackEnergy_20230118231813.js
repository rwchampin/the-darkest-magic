...
void main() {
    gl_PointSize = 1.;
    float speed = 20.; newPosition = position * (1. + curlNoise(position+u_time/speed)* 0.1);
...
export const useBlackEnergy = () => {
  const stars = () => {
    ...
    const theStars = new THREE.Points(starsGeometry, starPointMaterial)
  ...
  return { stars: stars(), planet: planet(), starLights: starLights() }
}
