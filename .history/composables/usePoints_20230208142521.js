   ...
   geometry.setAttribute( 'position', new THREE.Float32BufferAttribute( positions, 3 ) );
    ...
    const updateParticles = () => {
        ...
        //     debugger;
            ...
            const ll1 = v1.lerp(v2, .1)
            const ll2 = v1.lerp(v2, .2)
            const ll3 = v1.lerp(v2, .3)
            const ll4 = v1.lerp(v2, .4)
            const ll5 = v1.lerp(v2, .5)
            const ll6 = v1.lerp(v2, .6)
            const ll7 = v1.lerp(v2, .7)
            debugger
            ps[x] = finalX;
            ps[x + 1] = finalY;
            ps[x + 2] = finalZ
