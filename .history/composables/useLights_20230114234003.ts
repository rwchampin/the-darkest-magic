...
const useLightsFN = () => {
  ...
  const createAmbientLight = (color: ColorRepresentation | undefined, intensity: number | undefined: undefined | undefined: undefined) => {
    ambientLight = new THREE.AmbientLight(color, intensity)
    return ambientLight
  }

  const createDirectionalLight = (color: ColorRepresentation | undefined, intensity: number | undefined: undefined | undefined: undefined) => {
