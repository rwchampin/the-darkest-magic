   ...
   geometry.setAttribute( 'position', new THREE.Float32BufferAttribute( positions, 3 ) );
    ...
    const updateParticles = () => {
        ...
        //     debugger;
            ...
            const ll1 = THREE.Vector3.lerpVectors(v1, v2, .1);
            const l2l = THREE.Vector3.lerpVectors(v1, v2, .2);
            const l3l = THREE.Vector3.lerpVectors(v1, v2, .3);
            const l4l = THREE.Vector3.lerpVectors(v1, v2, .4);
            const l5l = THREE.Vector3.lerpVectors(v1, v2, .5);
            const l6l = THREE.Vector3.lerpVectors(v1, v2, .6);
            const l7l = THREE.Vector3.lerpVectors(v1, v2, .7);
            debugger
            ps[x] = finalX;
            ps[x + 1] = finalY;
            ps[x + 2] = finalZ
