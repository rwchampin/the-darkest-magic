...
const useLightsFN = () => {
  ...
  const createAmbientLight = (color: ColorRepresentation | undefined, intensity | undefined) => {
    ambientLight = new THREE.AmbientLight(color, intensity)
    return ambientLight
  }

  const createDirectionalLight = (color: ColorRepresentation | undefined, intensity | undefined) => {
    directionalLight = new THREE.DirectionalLight(color, intensity)
    return directionalLight
  }

  const createHemisphereLight = (color: ColorRepresentation | undefined, groundColor: ColorRepresentation | undefined, intensity | undefined) => {
    hemisphereLight = new THREE.HemisphereLight(color, groundColor, intensity)
    return hemisphereLight
  }

  const createPointLight = (color: ColorRepresentation | undefined, intensity | undefined, distance | undefined, decay | undefined) => {
    pointLight = new THREE.PointLight(color, intensity, distance, decay)
    return pointLight
  }

  const createRectAreaLight = (color: ColorRepresentation | undefined, intensity | undefined, width | undefined, height | undefined) => {
