...
export const usePoints = ({ scene, camera, renderer, nuxtApp }) => {
  ...
  for (let i = 0; i < MAX_PARTICLES; i++) {
    ...
    vectors[i] = vertex
http://www.mkgny.com/wp-content/uploads/2023/02/Magnolia-MA_Innovation_Logos_Artboard-01.png
    positions.push(vertex.x, vertex.y, vertex.z)
    http://www.mkgny.com/wp-content/uploads/2023/02/Magnolia-MA_Innovation_Logos_Artboard-06.png
