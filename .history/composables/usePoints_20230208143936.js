   ...
   geometry.setAttribute( 'position', new THREE.Float32BufferAttribute( positions, 3 ) );
    ...
    const updateParticles = () => {
        ...
        //     debugger;
            ...
            const lx = THREE.MathUtils.lerp(v1.x, v2.x, THREE.MathUtils.clamp(1,0,1))
            const ly = THREE.MathUtils.lerp(v1.y, v2.y, THREE.MathUtils.clamp(1,0,1))
            const lz = THREE.MathUtils.lerp(v1.z, v2.z, THREE.MathUtils.clamp(1,0,1))
