...
export const usePoints = ({ scene, camera, renderer, nuxtApp }) => {
    ...
    const updateParticles = () => {
        ...
        //     debugger;
            ...
            vectorPositions[x] = radius * Math.cos(theta) * Math.sin(phi)
            vectorPositions[x+1] = radius * Math.sin(theta) * Math.sin(phi)
            vectorPositions[x+2] = radius * Math.cos(phi);

            vectorPositions[x] =  x0 + Utils.noise.perlin3(x0, y0,z0) * THREE.MathUtils.randFloatSpread(.5)
            vectorPositions[x+1] = y0 + Utils.noise.simplex3(x0,y0,z0) * THREE.MathUtils.randFloatSpread(.5)
            vectorPositions[x+2] = z0 + Utils.noise.simplex3(x0,y0,z0)* THREE.MathUtils.randFloatSpread(.5)
