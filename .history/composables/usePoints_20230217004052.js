...
export const usePoints = ({ scene, camera, renderer, nuxtApp }) => {
  ...
  const updateParticles = () => {
    ...
    for (let q = 0; q < c; q += 3) {
      ...
      const x0 = radius * Math.cos(elapsedTime + theta) * Math.sin(phi)
      const y0 = radius * Math.sin(elapsedTime + theta) * Math.sin(phi)
      const z0 = radius * Math.cos(elapsedTime + phi) 
    ...
    particles.geometry.attributes.position.needsUpdate = true
      ...
      // const lx = THREE.MathUtils.lerp(v1.x, x0, t)
      // const ly = THREE.MathUtils.lerp(v1.y, y0, t)
      // const lz = THREE.Ma    thUtils.lerp(v1.z, z0, t)
