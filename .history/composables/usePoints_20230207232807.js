...
export const usePoints = ({ scene, camera, renderer }) => {
    ...
    const colorList = chroma.scale(['darkblue', 'lightblue', "violet"]).colors(20);
    ...
    material = new THREE.PointsMaterial({ sizeAttenuation: true, vertexColors: true, transparent: true });
