...
const val = Math.random() * (Math.PI*2);
            ...
            ps[q] += THREE.MathUtils.clamp(elapsedTime, 0, Math.PI*2) 
            ps[q+1] += THREE.MathUtils.clamp(elapsedTime, 0, Math.PI*2) 
            ps[q+2] += THREE.MathUtils.clamp(elapsedTime, 0, Math.PI*2) 
        }
