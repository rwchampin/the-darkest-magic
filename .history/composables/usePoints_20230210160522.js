...
let sphere, satellite
  const geometry = new THREE.SphereGeometry( 1, 32, 32 );
			...
			function animate()
            {
                ...
                //satellite
                satellite.position.x =  sphere.position.x + Math.sin(elapsed*2) * 20;
                satellite.position.z = sphere.position.z + Math.cos(elapsed*2) * 20;
...
//             const vec = tits[x]
//             vec.applyAxisAngle(vec.rotationAxis, 0.1); 
//             ps[x] = vec.x;
//             ps[x + 1] = vec.y
//             ps[x+2] = vec.z
//         }
