...
export const usePoints = ({ scene, camera, renderer, nuxtApp }) => {
    ...
    const updateParticles = () => {
        ...
        //     debugger;
            ...
            ps[x] =  improved.noise(x0, y0,z0) * THREE.MathUtils.randFloatSpread(.5)
            ps[x + 1] = improved.noise(x1, y1,z1) * THREE.MathUtils.randFloatSpread(.5)
            ps[x + 2] = improved.noise(x2, y2,z2)* THREE.MathUtils.randFloatSpread(.5)
