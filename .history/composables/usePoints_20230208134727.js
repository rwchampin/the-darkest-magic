...
export const usePoints = ({ scene, camera, renderer, nuxtApp }) => {
    ...
    const updateParticles = () => {
        ...
        //     debugger;
            ...
            vp[i].x =  vp[i].x + Utils.noise.perlin3(vp[i].x, vp[i].x,vp[i].z) * THREE.MathUtils.randFloatSpread(.5)
            vp[i].y = vp[i].y + Utils.noise.simplex3(vp[i].x, vp[i].x,vp[i].z) * THREE.MathUtils.randFloatSpread(.5)
            vp[i].z = vp[i].z + Utils.noise.simplex3(vp[i].x, vp[i].x,vp[i].z)* THREE.MathUtils.randFloatSpread(.5)
