...
let theta1 = 0, phi1 = 0; val = Math.random() * (Math.PI*2);
    const updateParticles = () => {
        ...
        for (let q = 0; q < ps.length; q+=3) {
            ...
            ps[q] = THREE.MathUtils.clamp(theta1, 0, Math.PI*2) 
            ps[q+1] = THREE.MathUtils.clamp(theta1, 0, Math.PI*2) 
            ps[q+2] = THREE.MathUtils.clamp(theta1, 0, Math.PI*2) 
            theta1 += val
        }
