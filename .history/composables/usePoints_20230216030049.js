...
if(theta >= (Math.PI*2)) {
    theta = 0
             ...
             theta = theta + (Math.PI * 0.0001);
        phi = phi + (Math.PI * 0.0001);
        console.log(theta, phi)
             ps[q] = radius * Math.cos(theta) * Math.sin(phi)
            ps[q + 1] = radius * Math.sin(theta) * Math.sin(phi)
            ps[q + 2] = radius * Math.cos(phi)
        }
