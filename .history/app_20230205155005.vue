...
let p, ambientLight, pointLight, stats, scene, camera, renderer, finalPass, ctx, canvas2d, updateVolumetricParticles
/*********************************
  * GLOBAL COMPONENTS
*********************************/
...
onMounted(() => {
  ...
  *********************************/
  ...
  gsap.ticker.add((time, deltaTime, frame) => {
    ...
    setInterval(updateVolumetricParticles, 10 / 24);
