                                                                                             ...
                                                                                             key: 'divideScalarY',
                                                                                              value(t) { 
                                                                                                return t === 0 ? void console.log('! Cannot divide by zero !') : (this.Y /= t || 1, this) } }, {
                                                                                                     ...
                                                                                                     key: 'getMagnitude', value() { return Math.sqrt(this.x ** 2 + this.y ** 2) } }, {
                                                                                                         
                                                                                                        key: 'normalize', value() { this.divideScalar(this.getMagnitude()) } }, {
                                                                                                             
                                                                                                            key: 'randomize', value(i) { return i = i || new t(1, 1), this.x = Math.random() * i.x, this.y = Math.random() * i.y, this } }, {
                                                                                                                 
                                                                                                    key: 'addRandom', value(t) { t = t || 0, this.x += t - Math.random() * (2 * t), this.y += t - Math.random() * (2 * t) } }, {
                                                                                                         key: 'addRandomX', value(t) { t = t || 0, this.x += t - Math.random() * (2 * t) } }, {
                                                                                                         key: 'addRandomY', value(t) { t = t || 0, this.y += t - Math.random() * (2 * t) } }, {
                                                                                                         ...
                                                                                                         key: 'slope', value(t) { return (t.y - this.y) / (t.x - this.x) * -1 } }, {
                                                                                                         key: 'intercept', value(t) { return console.log(-t * this.x + this.y), -t * this.x + this.y } }, {
                                                                                                         key: 'distanceTo', value(t) { return t = t || this, Math.sqrt((t.x - this.x) ** 2 + (t.y - this.y) ** 2) } }, {
                                                                                                         
                                                                                                    key: 'angleTo', value(t, i) { return t = t || this, (i = i || 'rad') === 'rad' ? Math.atan2(t.y - this.y, t.x - this.x) : i === 'deg' ? 180 * Math.atan2(t.y - this.y, t.x - this.x) / Math.PI : void 0 } }]), t }())
