...
this.position = this.bind(this.position, this)
this.velocity = this.bind(this.velocity, this)
this.acceleration = this.bind(this.acceleration, this)
Particle.size = 2
