...
Emitter.prototype.addParticle = function () {
  ...
  const fromAngle = Vector.fromAngle(this.velocity.getAngle() + this.spread - (Math.random() * this.spread * 2), this.velocity.getMagnitude())
  console.log('pos', pos)
  console.log('fromAngle', fromAngle)
