...
// define(['examples', 'lib/Vector', 'lib/Particle', 'lib/Field', 'lib/Emitter'], (examples, Vector, Particle, Field, Emitter) => {
//   'use strict'

export default function GUI(particleSystem, display) {
