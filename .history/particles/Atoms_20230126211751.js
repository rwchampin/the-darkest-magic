const Vector2 = function () {
  ...
  return _createClass(t, [
    ...
    },
    {
      ...
      key: 'randomize', value(i) { 
        return i = i || new t(1, 1),
        this.x = Math.random() * i.x, this.y = Math.random() * i.y, this },
    }, {
...
export class Atoms {
  constructor() {
    this.canvas = document.querySelector('.main-canvas-2d')
    this.PI = Math.PI
    this.TAU = this.PI * 2
