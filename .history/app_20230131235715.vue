...
let onFrame, mousePointLight; let scene; let camera; let renderer; let ambientLight; let pointLight; let directionalLight; let rectAreaLight; let spotLight; let hemisphereLight
...
onMounted(() => {
  ...
  onFrame = useVolumetric({ scene, camera, renderer })
