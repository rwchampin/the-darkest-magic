...
onMounted(() => {
  ...
  const c1 = createCanvas({ width: w / 2, height: 300 })
  const c2 = createCanvas({ width: w / 2, height: 300 })
  const c3 = createCanvas({ width: w / 2, height: 300 })
  ...
  function writeText(canvas, context, text) {
    const size = 300
    context.font = '200px Montserrat-Black'
