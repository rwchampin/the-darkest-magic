...
export class Vectormation {
  constructor({ canvas, context, width, height, pointerEvents = false, fullScreen = true, bg = 'transparent' }) {
    ...
    this.ctx.canvas.width = !this.fullScreen ?? this.width
    this.ctx.canvas.height = !this.fullScreen ?? this.height
    this.ctx.canvas.style.width = !this.fullScreen ?? `${this.width}px`
    this.ctx.canvas.style.height = !this.fullScreen ?? `${this.height}px`
