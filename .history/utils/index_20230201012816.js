  ...
  three: {
    createPoints: ({ geometry, count }) => {
      ...
      for (let i = 0; i < count; i++) {
        ...
        const p2 = Utils.math.randomPointsInGeometry(geometry)
        const p3 = Utils.math.randomPointsInGeometry(geometry)
        const p4 = Utils.math.randomPointsInGeometry(geometry)
