  ...
  three: {
    createPoints: ({ geometry, count }) => {
      ...
      for (let i = 0; i < count; i++) {
        ...
        const p2 = Utils.geometry.randomPointsInBufferGeometry(geometry)
        const p3 = Utils.geometry.randomPointsInBufferGeometry(geometry)
        const p4 = Utils.geometry.randomPointsInBufferGeometry(geometry)
        debugger
