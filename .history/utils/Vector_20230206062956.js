...
static static addX = function (v, s) {
...
Vector3.prototype.addScalar(s) {
    return new Vector3(this.x + s, this.y + s, this.z + s)
  }
  Vector3.prototype.subtract(v) {
    if (v instanceof Vector3)
      return new Vector3(this.x - v.x, this.y - v.y, this.z - v.z)
    else return new Vector3(this.x - v, this.y - v, this.z - v)
  }
  Vector3.prototype.multiply(v) {
    if (v instanceof Vector3)
      return new Vector3(this.x * v.x, this.y * v.y, this.z * v.z)
    else return new Vector3(this.x * v, this.y * v, this.z * v)
  }
  Vector3.prototype.divide(v) {
    if (v instanceof Vector3)
      return new Vector3(this.x / v.x, this.y / v.y, this.z / v.z)
    else return new Vector3(this.x / v, this.y / v, this.z / v)
  }
  Vector3.prototype.equals(v) {
    return this.x === v.x && this.y === v.y && this.z === v.z
  }
  Vector3.prototype.dot(v) {
    return this.x * v.x + this.y * v.y + this.z * v.z
  }
  Vector3.prototype.cross(v) {
    return new Vector3(
  ...
  Vector3.prototype.unit() {
    return this.divide(this.length())
  }
  Vector3.prototype.min() {
    return Math.min(Math.min(this.x, this.y), this.z)
  }
  Vector3.prototype.max() {
    return Math.max(Math.max(this.x, this.y), this.z)
  }
  Vector3.prototype.toAngles() {
    return {
      theta: Math.atan2(this.z, this.x),
      phi: Math.asin(this.y / this.length()),
    }
  }
  Vector3.prototype.angleTo(a) {
    return Math.acos(this.dot(a) / (this.length() * a.length()))
  }
  Vector3.prototype.toArray(n) {
    return [this.x, this.y, this.z].slice(0, n || 3)
  }
  Vector3.prototype.clone() {
    return new Vector3(this.x, this.y, this.z)
  }
  Vector3.prototype.init(x, y, z) {
