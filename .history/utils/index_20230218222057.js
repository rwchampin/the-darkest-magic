...
export const Utils = {
  ...
  three: {
    ...
    createMesh: (positions, scene, scale, x, y, z, color) => {
      ...
      geometry.setAttribute('position', positions.clone().setUsage(THREE.DynamicDrawUsage))
      ...
      const clonemeshes = new Float32Array(clones.length)
      for (let i = 0; i < clones.length; i++) {
        ...
        clonemeshes[i] = { mesh, speed: 0.5 + Math.random() }
      }
