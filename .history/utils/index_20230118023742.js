  ...
  math: {
    ...
    v2: {
      ...
      lerpDistance: (v1, v2, t) => {
         ...
         * @param {Number} t: the amount to lerp
         * @returns {Object}
      ...
      angleTo: (v1, v2) => {
         ...
         * @example: const angle = Utils.math.v2.angleTo(v1, v2)
         * @example: const angle = Utils.math.v2.angleBetween(v1, v2)
         * @example: const angle = Utils.math.v2.getAngle(v1, v2)
         * @example: const angle = Utils.math.v2.getAngleBetween(v1, v2)
