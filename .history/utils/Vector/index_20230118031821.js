...
// static methods
Vector2.randomVec2 = function (scale = Math.random()) {
  /****
     * Returns a random vector with a length of 1
     * @param {Number} scale: The maximum length of the vector, defaults to 1 typically a number between 0 and 1
     * @returns {Vector2}
     * @example Vector2.randomVec2(10)
     */
