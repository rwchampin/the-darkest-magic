  ...
  three: {
    createPoints: ({ geometry, count }) => {
      ...
      for (let i = 0; i < count; i++) {
        ...
        const p2 = Utils.geometry.randomPointsInGeometry(geometry)
        const p3 = Utils.geometry.randomPointsInGeometry(geometry)
        const p4 = Utils.geometry.randomPointsInGeometry(geometry)
        debugger
