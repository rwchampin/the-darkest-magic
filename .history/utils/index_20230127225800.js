  ...
  color: {
    getColorsHSL: (color) => {
      ...
      const colorStrings = [
        {
          color: 'green',
         str: `#${new THREE.Color().setHSL(0.25 + i / 3 * 0.25, 0.6, 0.7).getHexString()}`,
        },
        {
          color: 'blue',
         str: `#${new THREE.Color().setHSL(0.5 + i / 3 * 0.25, 0.6, 0.7).getHexString()}`,
        },
        {
          color: 'red',
          str:`#${new THREE.Color().setHSL(0.0 + i / 3 * 0.25, 0.6, 0.7).getHexString()}`,
        },
        {
          color: 'yellow',
          str:`#${new THREE.Color().setHSL(0.75 + i / 3 * 0.25, 0.6, 0.7).getHexString()}`,
        },
      ]
      for (let i = 0; i < 4; i += 1) {
        colors.push(
          colorStrings[color].str
        )
      }
      return colors
    },
    ...
    getGreenHSL: () => {  
      ...
      for (let i = 0; i < 4; i += 1) {
        colors.push(
    `#${new THREE.Color().setHSL(0.25 + i / 3 * 0.25, 0.6, 0.7).getHexString()}`,
