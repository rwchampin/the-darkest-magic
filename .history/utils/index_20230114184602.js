...
const simplex2D = createNoise2D(Date.now())
const simplex3D = createNoise3D(Date.now())
const simplex4D = createNoise4D(Date.now())
...
export const Utils = {
  ...
  geometry: {
    ...
    computeCurl: (x, y, z) => {
      ...
      let n1 = simplex.noise2D(x, y + eps, z)
      let n2 = simplex.noise2D(x, y - eps, z)
