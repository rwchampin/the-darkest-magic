  ...
  three: {
    ...
    createPoints: ({ bufferGeometry, count }) => {
      ...
      for (let i = 0; i < count; i++) {
        ...
        const p3 = Utils.geometry.randomPointsInBufferGeometry(bufferGeometry, 400)
        const p4 = Utils.geometry.randomPointsInBufferGeometry(bufferGeometry, 400)
        vertices.push(p, p2, p3, p4)
      }

      pgeometry.setAttribute('position', new THREE.Float32BufferAttribute(vertices, 3).setUsage(THREE.DynamicDrawUsage))
