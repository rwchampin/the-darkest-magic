...
onMounted(() => {
  ...
  const c1 = createCanvas({ width: window.innerWidth, height: $(window).height() })
  const c2 = createCanvas({ width: window.innerWidth, height: $(window).height() })
  const c3 = createCanvas({ width: window.innerWidth, height: $(window).height() })
