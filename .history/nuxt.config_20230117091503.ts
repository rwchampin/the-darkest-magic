...
export default defineNuxtConfig({
  server: {
    https: {
      key: fs.readFileSync(fileURLToPath(new URL('./ssl/localhost-key.pem', import.meta.url))),
      cert: fs.readFileSync(fileURLToPath(new URL('./ssl/localhost.pem', import.meta.url))),
    },
  },
  head: {
    script: [
      {
        src: 'https://cdn.jsdelivr.net/gh/SeanFree/Vector2@master/Vector2.min.js',

      },
      {
        src: 'https://cdn.jsdelivr.net/gh/josephg/noisejs@master/perlin.js',
      ...
      {
        src: '~/particles/core/vendor/lodash.js',
  ...
  build: {
    external: [
      'https://cdn.jsdelivr.net/gh/SeanFree/Vector2@master/Vector2.min.js',
      'https://cdn.jsdelivr.net/gh/josephg/noisejs@master/perlin.js',
