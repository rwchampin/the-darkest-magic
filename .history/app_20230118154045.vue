...
let stats, planet, stars, starlight, suniforms, scene, camera, renderer, ambientLight, pointLight, directionalLight, rectAreaLight, spotLight, hemisphereLight
...
onMounted(() => {
  nextTick(() => {
    ...
    scene.add(mesh, ambientLight, camera, pointLight, spotLight, mousePointLight)
