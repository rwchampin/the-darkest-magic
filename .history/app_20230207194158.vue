...
onMounted(() => {
  ...
  *********************************/
  ...
  function init() {
    ...
    geometry.setAttribute('posrition', new THREE.Float32BufferAttribute(vertices, 3));

    material = new THREE.PointsMaterial({ color: 0x000000.size: 35, sizeAttenuation: true, alphaTest: 0.5, transparent: true });
