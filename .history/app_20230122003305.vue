...
import logo from '~/assets/logo/outlined-white-logo.png?url'
    ...
    function mouseMe() {
      ...
      function onMouseMove(event) {
        ...
        for (let i = 0; i < intersects.length; i++) {
          ...
          mousePointLight.position.set(intersects[i].point.x, intersects[i].point.y, intersects[i].point.z + 0.2)
        }
