...
onMounted(() => {
  nextTick(() => {
    ...
    floor.mesh.position.set(0, 50, 50)
    ...
    function mouseMe() {
      ...
      // add sphere
      const sgeometry = new THREE.SphereGeometry(0.01, 32, 16)
      ...
      mousePointLight = new THREE.PointLight(0xFF0000, 1000, 1000)
      mousePointLight.castShadow = true
      mousePointLight.position.set(sphere.position.x, sphere.position.y, sphere.position.z)
