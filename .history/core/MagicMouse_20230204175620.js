...
export default class MagicMouse {
  ...
  animate() {
    ...
    document.getElementById("cursor").style.transform = `scale(${mouseScale}) translate(${instance.elasticMouse.x}px, ${instance.elasticMouse.y}px)`
    ...
    instance.light.position.set(instance.elasticMouse.x, instance.elasticMouse.y, 0)

    instance.material.uniforms.uLight.value = instance.elasticMouse.position
