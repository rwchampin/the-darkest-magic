...
export default class Resources extends EventEmitter {
  ...
  constructor() {
    ...
    this.lm = new LoadingManager(this.onCompleted, this.onProgress, this.onError)
    this.setLoaders()
  ...
  onProgress(_url, _itemsLoaded, _itemsTotal) {
    this.progress = _itemsLoaded / _itemsTotal 
    this.trigger('assets:progress', [_url, _itemsLoaded, _itemsTotal])
  }
  ...
  setLoaders() {
    ...
    // Draco
    const dracoLoader = new DRACOLoader(lm)
    ...
    // FBX
    const fbxLoader = new FBXLoader(lm)
    ...
    // RGBE | HDR
    const rgbeLoader = new RGBELoader(lm)
