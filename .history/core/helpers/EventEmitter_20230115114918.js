export default class {
  ...
  on(_names, callback) {
    ...
    => {
      ...
      if (!(Array.isArray(that.callbacks[name.namespace][name.value])))
      ...
      // Remove specific callback in namespace
        ...
        if (name.namespace === 'base') {
          ...
          for (const namespace in that.callbacks) {
            if (that.callbacks[namespace] instanceof Object && Array.isArray(that.callbacks[namespace][name.value])) {
        ...
        // Specified namespace
        else if (that.callbacks[name.namespace] instanceof Object && Array.isArray(that.callbacks[name.namespace][name.value])) {
