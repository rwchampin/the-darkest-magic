...
export default class Experience {
  ...
  constructor(_options = {}) {
    ...
    this.resources.on('assets:progress', (progress) => {
      this.progress = progress.toLoad / progress.loaded * 100
    })
  ...
  setResources() {
    this.resources = new Resources(this.nuxtApp, assets)
  }
