...
let stats, planet, stars, starlight, suniforms, scene: THREE.Scene, camera: THREE.PerspectiveCamera | THREE.Camera | THREE.Object3D<THREE.Event>, renderer: THREE.WebGLRenderer, ambientLight, pointLight, directionalLight, rectAreaLight, spotLight, hemisphereLight
