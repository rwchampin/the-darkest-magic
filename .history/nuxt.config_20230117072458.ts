...
export default defineNuxtConfig({
  server: {
    https: {
      key: fs.readFileSync(fileURLToPath(new URL('./ssl/localhost.key', import.meta.url))),
      cert: fs.readFileSync(fileURLToPath(new URL('./ssl/localhost.crt', import.meta.url))),
    },
  },
  alias: {
