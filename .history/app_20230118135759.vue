...
let uniforms, suniforms, scene, camera, renderer, ambientLight, pointLight, directionalLight, rectAreaLight, spotLight, hemisphereLight
...
onMounted(() => {
  nextTick(() => {
    ...
    const { smaterial, suniforms } = Effects.createWobblyMaterial()
