...
const b = () => {
  ...
  const theta0 = 20; const phi0 = 20; const radius = 10; const verts = []; const sizes = []
  ...
  function udatepts() {
    ...
    for (let i = 0; i < g.count; i += 3) {
      ...
      v1.randomDirection().normalize().multiplyScalar(5)
      g.array[i] = v1.x * 0.01
      g.array[i + 1] = v1.y * 0.01
      g.array[i + 2] = v1.z * 0.01
    }
