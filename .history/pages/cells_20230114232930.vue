...
let data, tela: HTMLCanvasElement | CanvasRenderingContext2D | null, canvas: HTMLCanvasElement | CanvasRenderingContext2D | null
...
class FishEgg {
  ...
  createCircle(x: any, y: any, r: any, c: string) {
...
class FishLarva {
  constructor(canvas: any, progress: undefined) {
    const random = Math.random()
    this.progress = 0
    this.canvas = canvas
