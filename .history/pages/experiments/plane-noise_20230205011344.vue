...
noisePlaneFolder.add(params, 'blocks').min(10).max(100).onChange(createGeometry)
noisePlaneFolder.add(params, 'smoothing').min(100).max(3000).step(1)
noisePlaneFolder.add(params, 'amplitude').min(0).max(1000).step(1)
noisePlaneFolder.add(params, 'speed').min(0).max(0.01).step(0.00001)
noisePlaneFolder.add(params, 'rotationX').min(-359).max(359).step(1).onChange(createGeometry)
noisePlaneFolder.add(params, 'rotationZ').min(-359).max(359).step(1).onChange(createGeometry)
...
<template>
  <section class="page page-experiments--plane-noise">
    <h1>fsff</h1>
  </section>
</template>
