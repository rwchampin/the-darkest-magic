...
import { DebugEnvironment } from 'three/examples/jsm/libs/DebugEnvironment.js'
import { TesselateModifier } from 'three/examples/jsm/modifiers/TesselateModifier.js'
