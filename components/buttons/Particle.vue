    ...
    <div class="vue-particle-effect-button">
        <div class="particles">
            <div :style="wrapperStyl" class="particles-wrapper">
                <div :style="slotStyl" ref="btn" @click="disintegrate" v-if="$slots.default" class="particles-button"
                    :class="cls">
                    <slot>
            ...
            <canvas :style="canvasStyl" ref="canvas" class="particles-canvas"></canvas>
        </div>
    </div>
</template>
<script>
