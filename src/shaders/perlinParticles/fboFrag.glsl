...
vec4 j1=permute(permute(permute(permute(
            ...
            void main()
            {
                ...
                pos.x+=snoise(vec4(pos.x,pos.y,pos.z,timer/10000.))*.01;
                pos.y+=snoise(vec4(pos.x,pos.y,pos.z,1.352+timer/10000.))*.01;
                pos.z+=snoise(vec4(pos.x,pos.y,pos.z,12.352+timer/10000.))*.01;
